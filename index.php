 ...
 <!-- FlatFy Theme, Made by Andrea Galanti. big thank you /-->
...
<head>
    ...
    <meta name="description" content="Elitia Social Media Page ">
    <meta name="author" content="Elitia, Hajar EL KOUMIKHI">

    <title>Elitia Social Media Page ♥</title>
...
<body id="home">
    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			<h1 class="h1_home wow fadeIn" data-wow-delay="0.4s">Elitia</h1>
			<h3 class="h3_home wow fadeIn" data-wow-delay="0.6s">Dreamer & YouTuber ♥</h3>
			<ul class="list-inline intro-social-buttons">
				
				<li id="download" ><a href="#downloadlink" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.2s"><span class="network-name">Visitez mon blog</span></a>
				</li>
			</ul>
		</div>    
        <!-- /.container -->
	...
	<nav class="navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#home">Elitia</a>
			</div>

			<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					
					<li class="menuItem"><a href="#whatis">Follow Me</a></li>
	...
	<div id="whatis" class="content-section-b" style="border-top: 0">
		<div class="container">
			...
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
				<h2>Follow Me</h2>
				<p class="lead" style="margin-top:0">Retrouvez-moi sur les réseaux sociaux !</p>
			...
			<div class="row">
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img class="rotate" src="img\icon\facebook.png" alt="Generic placeholder image">
				  <h3>Facebook</h3>
				  <p class="lead">Retrouvez-moi sur Facebook : <a href="https://goo.gl/KYr3Pi">Elitia Galaxy</a> </p>               

				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="img\icon\twitter.png" alt="Generic placeholder image">
				   <h3>Twitter</h3>
				   <p class="lead">Retrouvez-moi sur Twitter : <a href="https://goo.gl/2Nt0wm">Elitia Galaxy</a> </p>
				   <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="img/icon/instagram.png" alt="Generic placeholder image">
				   <h3>Instagram</h3>
					<p class="lead">Retrouvez-moi également sur Instagram : <a href="https://goo.gl/f5BA50">Elitia Galaxy</a> </p>
				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
			...
			<div class="row tworow">
				...
				<div class="col-sm-4  wow fadeInDown text-center">
				  <img class="rotate" src="img/icon/googlePlus.png" alt="Generic placeholder image">
				  <h3>Google Plus</h3>
				  <p class="lead">Ma page Google+ : <a href="https://goo.gl/JxjW4S">Elitia Galaxy</a></p>
				 <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="img/icon/weHeartIT.png" alt="Generic placeholder image">
				   <h3>We♥It</h3>
				   <p class="lead">Mon compte We♥It :  </p>
				   <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="img/icon/pinterest.png" alt="Generic placeholder image">
				   <h3>Pinterest</h3>
				 <p class="lead">Rejoignez-moi sur Pinterest :  </p>
				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInLeftBig"  data-animation-delay="200">   
                    <h3 class="section-heading">Ma dernière vidéo</h3>
